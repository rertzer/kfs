...
typedef enum { SIG_IGNORE, SIG_DEFAULT, SIG_EXIT, SIG_CORE, SIG_STOP, SIG_CONTINUE } sig_default_t;
...
#define SIG_DEFAULT_VALUES                                                                                            \
	...
	[SIGSTKFLT] = SIG_EXIT, [SIGCHLD] = SIG_DEFAULT, [SIGCONT] = SIG_CONTINUE, [SIGSTOP] = SIG_STOP,                  \
